...
function ZoomContent({ zoom, width, height, stationCoordinate, highlightEdgeIds, highlightStationKeys }: ZoomContentProps) {
    ...
    useEffect(() => {
        ...
        zoom.setTransformMatrix({
            ...
            translateY: height / 2 - stationCoordinate![1] * scale,
            skewX: 0,
            skewY: 0,
        });
    }, [focusKey, stationCoordinate, width, height, zoom]);
...
const NetworkMap = React.memo(function ({
    ...
    const initialTransformMatrixRef = useRef({
        scaleX: 0.06,
        scaleY: 0.06,
        translateX: width / 2,
        translateY: clampedHeight / 2,
        skewX: 0,
        skewY: 0,
    });
