...
export const makeParallelPaths = (parallelLines: EdgeEntry<NodeAttributes, EdgeAttributes>[]) => {
    ...
    // @ts-expect-error generatePath's attr parameter is typed per path-type; TS can't correlate `type` with the spread attr
...
export const MAX_PARALLEL_LINES_FREE = Infinity;
